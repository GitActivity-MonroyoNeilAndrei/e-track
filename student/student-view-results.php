      ...
      <div class="nav-links">
        <nav style="position: sticky; top: 4vh;">
          <ul>
            ...
            <li onclick="window.location.href='student-view-results.php'"  class="bg-dark-gray2">View Election Results</li>
      ...
      <div class="content border border-primary">
        <div class="content-container">
          ...
          <div class="container-add-candidate">
            <h5 class="text-center py-1">THIS IS THE VIEW ELECTION RESULT</h5>
          </div>
