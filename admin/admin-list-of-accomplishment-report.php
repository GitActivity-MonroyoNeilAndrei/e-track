      ...
      <div class="nav-links">
        <nav style="position: sticky; top: 4vh;">
          <ul>
            ...
            <li onclick="window.location.href='admin-list-of-accomplishment-report.php'" class="mb-4 border-bottom border-dark bg-dark-gray2">List of Accomplishment Report</li>
